...
cpu_robot1 = DQ_SerialManipulatorDH(robot1_dh_mat)
# cpu robot2
robot2_config_dh_mat = np.array([[0.0, 0.15185, 0.0, 1.5708, 0],
...
cpu_robot2 = DQ_SerialManipulatorDH(robot2_dh_mat)
...
q_vec2 = torch.tensor([0.4, 0.3, 0.2, 0.1 ,0.2, 0.5], dtype=torch.float32, device= "cuda:0").repeat(batch_size, 1)
