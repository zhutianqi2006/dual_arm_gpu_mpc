...
from utils.icem_module import ICEMModule
import rclpy
import array
...
def main(args=None):
    ...
    cem_module = ICEMModule(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    cem_module.warm_up()
    while True:
        cem_module.play_once()
