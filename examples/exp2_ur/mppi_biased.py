...
from utils.mppi_biased_module import MPPIBiasedModule
# 
import rclpy
import array
...
def main(args=None):
    ...
    mppi_module = MPPIBiasedModule(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
