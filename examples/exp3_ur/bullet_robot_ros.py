...
def main(args=None):
    ...
    ur3_q = np.array([-1.527662583861533, -2.7952375814622523, -1.8015937445920502, -0.12914625711842023,  2.056833039438549, 0.1132209147429898])
    ur3e_q = np.array([2.030766796955004, -0.5943331511387977,  0.03790646240293063, -0.7048070210743321, -2.008923083731912, 3.592388979218865])
