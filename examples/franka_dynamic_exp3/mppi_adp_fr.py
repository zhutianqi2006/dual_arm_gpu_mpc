...
from utils.mppi_adp_module import MPPIAdpModule
# 
import rclpy
import array

class MPPIAdpModuleDynamic(MPPIAdpModule):
...
def main(args=None):
    ...
    mppi_module = MPPIAdpModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
