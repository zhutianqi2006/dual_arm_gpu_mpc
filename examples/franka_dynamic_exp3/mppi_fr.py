...
from utils.mppi_module import MPPIModule
# 
import rclpy
import array

class MPPIModuleDynamic(MPPIModule):
...
def main(args=None):
    ...
    mppi_module = MPPIModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
