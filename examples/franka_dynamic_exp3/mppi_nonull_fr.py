...
from utils.mppi_nonull_module import MPPINoNullModule
# 
import rclpy
import array

class MPPINoNullModuleDynamic(MPPINoNullModule):
...
def main(args=None):
    ...
    mppi_module = MPPINoNullModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
