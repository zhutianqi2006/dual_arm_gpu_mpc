...
from utils.mppi_nonull_high_module import MPPINoNullHighModule
# 
import rclpy
import array

class MPPINoNullHighModuleDynamic(MPPINoNullHighModule):
...
def main(args=None):
    ...
    mppi_module = MPPINoNullHighModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
