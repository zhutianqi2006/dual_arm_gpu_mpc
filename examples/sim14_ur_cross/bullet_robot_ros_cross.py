...
def main(argv=None):
    ...
    try:
        ur3_q = np.array([1.263158, 0.884211, 0.063158, 0.0, 0.0, -0.0], dtype=np.float64)
        ur3e_q = np.array([0.694737, 0.442105, 0.5, 0.5, 0.0, 0.0], dtype=np.float64)
