...
class MPPIKmeansAdpAnModuleDynamic(MPPIKmeansAdpAnModule):
    ...
    def update_curobo_world_model(self, time_elapsed:float):
       # obstacle 1
        ...
        self.curobo_config.world_model.world_model.cuboid[1].pose[1] = self.init_obstacle_y-100
    ...
    def update_fake_curobo_world_model(self, vel1:float, vel2:float):
        ...
        self.fake_obstacle_y += 0.0*vel2*self.mppi_dt*self.mppi_T
...
def main(args=None):
    ...
    config_path = os.path.join(os.path.dirname(__file__), 'two_franka_h20.yaml')
