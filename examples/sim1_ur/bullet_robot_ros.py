...
def main(args=None):
    ...
    ur3_q = np.array([-1.880045095815213, -2.795307177808226, -0.5964479412581589, -1.5539882438511055,  2.016087327992113, -0.3491149496371539])
    ur3e_q = np.array([1.875556372520332, -0.4101345299593827, 0.7340619962523387, -1.7073878143999608, -2.0509990890852294, 3.4525046361701044])
