...
if __name__ == "__main__":
    ...
    cfg_path = os.path.join(os.path.dirname(__file__), "ur3_and_ur3e_3row.yaml")
    ...
    obstacles = [
        ...
        {"center": np.array([0.45, 0.12, 0.25]), "radius": 0.04, "buffer": 0.01, "weight": 2e6, "color": [1, 0, 0, 0.35]},
        {"center": np.array([0.40, 0.00, 0.25]), "radius": 0.04, "buffer": 0.01, "weight": 2e6, "color": [1, 0, 0, 0.35]},
        {"center": np.array([0.40, 0.06, 0.25]), "radius": 0.04, "buffer": 0.01, "weight": 2e6, "color": [1, 0, 0, 0.35]},
        {"center": np.array([0.40, -0.06, 0.25]), "radius": 0.04, "buffer": 0.01, "weight": 2e6, "color": [1, 0, 0, 0.35]},
        {"center": np.array([0.40, -0.12, 0.25]), "radius": 0.04, "buffer": 0.01, "weight": 2e6, "color": [1, 0, 0, 0.35]},
        {"center": np.array([0.40, 0.12, 0.25]), "radius": 0.04, "buffer": 0.01, "weight": 2e6, "color": [1, 0, 0, 0.35]},
    ]
