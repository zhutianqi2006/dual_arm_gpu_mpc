...
def main(args=None):
    ...
    desire_abs_pose = [- 0.009809, - 0.700866, - 0.008828, 0.713171, 0.015061, - 0.000441, - 0.300637, - 0.003948]
    desire_abs_position = [0.45, 0.0, 0.40]
    ...
    config_path = os.path.join(os.path.dirname(__file__), 'ur3_and_ur3e_3row.yaml')
