...
from utils.mppi_kmeans_adpan_sg_plot_module import MPPIKmeansAdpAnSgPlotModule
# 
import rclpy
import array
...
def main(args=None):
    ...
    mppi_module = MPPIKmeansAdpAnSgPlotModule(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
