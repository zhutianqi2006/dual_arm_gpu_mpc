...
from utils.mppi_five_module import MPPIFiveModule
# 
import rclpy
import array

class MPPIFiveModuleDynamic(MPPIFiveModule):
...
def main(args=None):
    ...
    mppi_module = MPPIFiveModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
