...
from utils.mppi_new_inv_module import MPPINewInvModule
# 
import rclpy
import array
class MPPINewInvModuleDynamic(MPPINewInvModule):
...
def main(args=None):
    ...
    mppi_module = MPPINewInvModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
