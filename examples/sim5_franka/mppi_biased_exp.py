...
from utils.mppi_biased_exp_module import MPPIBiasedExpModule
# 
import rclpy
import array

class MPPIBiasedExpModuleDynamic(MPPIBiasedExpModule):
...
def main(args=None):
    ...
    mppi_module = MPPIBiasedExpModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
