...
from utils.mppi_biased_std_module import MPPIBiasedStdModule
# 
import rclpy
import array

class MPPIBiasedStdModuleDynamic(MPPIBiasedStdModule):
...
def main(args=None):
    ...
    mppi_module = MPPIBiasedStdModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
