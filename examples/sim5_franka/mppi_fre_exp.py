...
from utils.mppi_fre_exp_module import MPPIFreExpModule
# 
import rclpy
import array

class MPPIFreExpModuleDynamic(MPPIFreExpModule):
...
def main(args=None):
    ...
    mppi_module = MPPIFreExpModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
