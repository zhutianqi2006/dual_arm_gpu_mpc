...
from utils.mppi_fre_std_module import MPPIFreStdModule
# 
import rclpy
import array

class MPPIFreStdModuleDynamic(MPPIFreStdModule):
...
def main(args=None):
    ...
    mppi_module = MPPIFreStdModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
