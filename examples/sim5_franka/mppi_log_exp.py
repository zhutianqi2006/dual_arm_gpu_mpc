...
from utils.mppi_log_exp_module import MPPILogExpModule
# 
import rclpy
import array

class MPPILogExpModuleDynamic(MPPILogExpModule):
...
def main(args=None):
    ...
    mppi_module = MPPILogExpModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
