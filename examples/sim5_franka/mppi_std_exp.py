...
from utils.mppi_std_exp_module import MPPIStdExpModule
# 
import rclpy
import array

class MPPIStdExpModuleDynamic(MPPIStdExpModule):
...
def main(args=None):
    ...
    mppi_module = MPPIStdExpModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
