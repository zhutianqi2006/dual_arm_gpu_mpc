...
from utils.mppi_std_std_module import MPPIStdStdModule
# 
import rclpy
import array

class MPPIStdStdModuleDynamic(MPPIStdStdModule):
...
def main(args=None):
    ...
    mppi_module = MPPIStdStdModuleDynamic(config, desire_abs_pose, desire_abs_position, desire_rel_pose, desire_line_d, desire_quat_line_ref)
    mppi_module.warm_up()
    while True:
