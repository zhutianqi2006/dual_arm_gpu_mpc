...
class CEMModule:
    ...
    def __init__(
        ...
        self.cem_iters = getattr(config, "cem_iters", 10)
        self.cem_alpha = getattr(config, "cem_alpha", 1.0)  # higher -> track elites more
        self.init_std = getattr(config, "cem_init_std", 0.6)
