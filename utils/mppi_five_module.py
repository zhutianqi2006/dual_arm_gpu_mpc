...
class MPPIFiveModule():
    ...
    def mppi_worker2(self):
        ...
        std_schedule = [base_std / 2.0, base_std / 3.0, base_std / 4.0, base_std / 5.0]
        std_schedule = [base_std / 10.0, base_std / 100.0, base_std / 500.0, base_std / 1000.0]
        ...
        for stage_idx, stage_std in enumerate(std_schedule, start=1):
            ...
            self.last_mppi_result = self.current_mppi_result.clone()
